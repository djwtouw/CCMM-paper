...
################################################################################
# Load losses for n = 1000 and n = 5000 for SSNAL
################################################################################
losses1000[, "SSNAL"]  = c(load_bin("Numerical Results/Output/losses_1000.bin",
                                    n = length(lambdas)))
losses5000[, "SSNAL"]  = c(load_bin("Numerical Results/Output/losses_5000.bin",
                                    n = length(lambdas)))
